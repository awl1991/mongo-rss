...
/**
 * Format a date string to user's local timezone with a user-friendly format
...
function formatDatetimeToCentral(dtString) {
    try {
        ...
        // In the browser, we let the browser determine the local timezone
        // by not specifying a timeZone in the options
        // On the server, we'll use UTC and client will reformat it
